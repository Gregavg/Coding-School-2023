...
namespace Session_23.EF.Configurations
{
    public class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
    {
        public void Configure(EntityTypeBuilder<Transaction> builder)
        {
            ...
            builder.Property(t => t.PetPrice).HasPrecision(6, 2).IsRequired();
            builder.Property(t => t.PetFoodQty).IsRequired();
            builder.Property(t => t.PetFoodPrice).HasPrecision(6, 2).IsRequired();
            builder.Property(t => t.TotalPrice).HasPrecision(7, 2).IsRequired();
