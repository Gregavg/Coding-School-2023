...
//        private readonly IEntityRepo<Item> _productRepo;
...
//        // Constructors
//        public MonthlyLedgerController(IEntityRepo<Transaction> transactionRepo, IEntityRepo<Employee> employeeRepo, IEntityRepo<Item> productRepo) {
...
//                        monthlyLedger.Expenses += _productRepo.GetById(transactionLine.ItemId).Cost * transactionLine.Quantity;
