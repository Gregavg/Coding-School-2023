...
namespace Session_06 {
    public class University : Institute{
        ...
        public University(Guid id, string name, int yearsInService, Student[] student, Course[] courses) 
        ...
        public University(Guid id, string name, int yearsInService, Student[] student, Course[] courses, Grade[] grades, Schedule[] scheduledCourse)
        : base(id, name, yearsInService) {
            Students = student;
            Courses = courses;
            Grades = grades;
